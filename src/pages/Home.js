...
export default function Home() {
    ...
    function days() {
        let daysList = []
        let days = [
           "Pride Flags","Image Collage Maker","Inktober","Text Analyzer","Pixel Art Maker","Plant Library","Picture Canvas","feelings", "Mental Health Message","Solar System","This Website"]
