...
export default function Home() {
    ...
    function days() {
        let daysList = []
        let days = [
           "GraphQL Currency Exchange Rate", "Animal Crossing Library","Live Twitch Streamers","Recipe Library","Computer Vision Images","Theme Changer","Image Filters","DevJobs","Animation Practice","Animated Shapes","Collage Maker","Pride Flags","Inktober","Text Analyzer","Pixel Art Maker","Plant Library","feelings","Solar System","This Website"]
            ...
            <div className="firstPanel">
                <div>
                    ...
                    <div className="desc up">
                        <Fade clear cascade>
                        <p>I enjoy working with multiple problems and look for ways to <br></br>incorporate design and code into my work. I am passionate about using art and code to convey a delightful experience for each user. In my free time, I enjoy cooking, gaming, and karoke!</p>
                        </Fade>
                    </div>
                    <div>
                    </div>
