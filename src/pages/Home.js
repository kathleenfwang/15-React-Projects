...
export default function Home() {
    ...
    function days() {
        let daysList = []
        let days = [
           "Image Filters","DevJobs","Animation Practice","Animated Shapes","Collage Maker","Pride Flags","Inktober","Text Analyzer","Pixel Art Maker","Plant Library","Picture Canvas","feelings", "Mental Health Message","Solar System","This Website"]
