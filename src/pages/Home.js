...
export default function Home() {
    ...
    function days() {
        let daysList = []
        let days = [
           "Live Twitch Streamers","Recipe Library","Computer Vision Images","Theme Changer","Image Filters","DevJobs","Animation Practice","Animated Shapes","Collage Maker","Pride Flags","Inktober","Text Analyzer","Pixel Art Maker","Plant Library","feelings","Solar System","This Website"]
